...
Map<Integer, List<CD>> map11 = CD.cdList.stream()
    .collect(Collectors.groupingBy(CD::getNoOfTracks));
System.out.println(map11);

Map<Integer, List<CD>> map22 = CD.cdList.stream()
    .collect(Collectors.groupingBy(CD::getNoOfTracks, Collectors.toList()));
...
Map<Integer, Set<CD>> map44 = CD.cdList.stream()
    .collect(Collectors.groupingBy(CD::getNoOfTracks, Collectors.toSet()));
System.out.println(map44);

Map<Integer, Long> map55 = CD.cdList.stream()
    .collect(Collectors.groupingBy(CD::getNoOfTracks, Collectors.counting()));
//{6=1, 8=2, 10=2}
System.out.println(map55);

ConcurrentMap<Integer, Long> map66 = CD.cdList.parallelStream()
    .collect(Collectors.groupingByConcurrent(CD::getNoOfTracks,
                                             Collectors.counting()));
//{6=1, 8=2, 10=2}
...
Map<Integer, Map<Genre, List<CD>>> twoLevelGrp = CD.cdList.stream()
    .collect(Collectors.groupingBy(CD::getNoOfTracks,          // (1)
             Collectors.groupingBy(CD::getGenre)));            // (2)
...
Map<Integer, Map<Genre, Long>> twoLevelGrp2 = CD.cdList.stream()
    .collect(Collectors.groupingBy(CD::getNoOfTracks,
             Collectors.groupingBy(CD::getGenre,
    ...
    Map<Integer, List<String>> map77 = CD.cdList.stream()
        .collect(Collectors.groupingBy(
            CD::getNoOfTracks,
            TreeMap::new,
            Collectors.mapping(CD::getTitle, Collectors.toList())));
    ...
    Map<Integer, Optional<Character>> map3 = CD.cdList.stream().collect(
        Collectors.groupingBy(
            cd -> cd.getTitle().length(),
            Collectors.mapping(
                cd -> cd.getTitle().charAt(0),
