...
List<String> listOfCDNames = CD.cdList
    .stream()                                            // Stream<CD>
    .filter(cd -> cd.getYear().equals(Year.of(2018)))    // Stream<CD>
...

{
  ...
  List<String> listOfCDNames = cdList
      .stream()                                               // Stream<CD>
      .peek(cd -> System.out.println("Filterinng: " + cd.getTitle()))
      .filter(cd -> cd.getYear().equals(Year.of(2018)))       // Stream<CD>
      .peek(cd -> System.out.println("Mapping: " + cd.getTitle()))
      .map(CD::getTitle)                                      // Stream<String>
      .collect(Collectors.toList());                          // List<String>
