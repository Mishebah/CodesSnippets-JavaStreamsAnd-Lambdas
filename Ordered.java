...
//   .limit(2)
//   .map(CD::getTitle)
//   .collect(Collectors.toList());                // [Java Jam, Keep on Erasing]
...
}
{
 ...
 // Query: Create a list with the first 2 CDs that were issued in 2018.
   long startTime = System.currentTimeMillis();
 List<CD> cds2018 = Arrays.asList(CD.cd0, CD.cd1, CD.cd2, CD.cd3, CD.cd4)
     .stream()
